...
var productsInCart = JSON.parse(localStorage.getItem('cartItems')) || [];
...
function getCartInItems() {
    ...
    if (productsInCart.length == 0) {
            ...
            for (let i = 0; i < productsInCart.length; i++) {
                    ...
                    `;
                    totalPriceInHeader += productsInCart[i].price * productsInCart[i].quantity;
            }
...
var productsInWishList = JSON.parse(localStorage.getItem('wishListItems')) || [];
